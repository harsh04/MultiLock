    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == RC_SIGN_IN){
            if(resultCode == RESULT_OK){
                ...
                n = (String) auth.getCurrentUser().getDisplayName();
                e = (String) auth.getCurrentUser().getEmail();
                name.setText(n);
                email.setText(e);
                sendAccInfo.putExtra("p_name",n);   //TODO: make it transfer value
                sendAccInfo.putExtra("p_email",e);
            }
            else {
